...
namespace TallerSaaS.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260318182124_UpdateNominaRentabilidad")]
    partial class UpdateNominaRentabilidad
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TallerSaaS.Domain.Entities.Appointment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("TallerSaaS.Domain.Entities.CuentaContable", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TallerSaaS.Domain.Entities.LineaAsientoContable", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("LineasAsientosContables");
                });

            modelBuilder.Entity("TallerSaaS.Domain.Entities.MechanicAvailability", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "MechanicId", "DayOfWeek")
                        .HasDatabaseName("IX_MechanicAvailabilities_Mechanic_Day_Active");
            ...
            modelBuilder.Entity("TallerSaaS.Domain.Entities.LineaAsientoContable", b =>
                {
                    b.HasOne("TallerSaaS.Domain.Entities.AsientoContable", "AsientoContable")
                        .WithMany("Lineas")
                        .HasForeignKey("AsientoContableId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TallerSaaS.Domain.Entities.CuentaContable", "CuentaContable")
                        .WithMany()
                        .HasForeignKey("CuentaContableId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TallerSaaS.Domain.Entities.Cliente", "Tercero")
                        .WithMany()

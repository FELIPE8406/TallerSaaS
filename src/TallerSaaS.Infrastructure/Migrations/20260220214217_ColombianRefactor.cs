...
{
    /// <inheritdoc />
    public partial class ColombianRefactor : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tenants_PlanesSuscripcion_PlanSuscripcionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiagnosticoInicial = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pagos_PlanesSuscripcion_PlanSuscripcionId",
                        column: x => x.PlanSuscripcionId,
                        principalTable: "PlanesSuscripcion",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductoInventarioId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemsOrden", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemsOrden_Inventario_ProductoInventarioId",
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Activo", "Descripcion", "LimiteUsuarios", "Nombre", "Precio" },
                values: new object[,]
                {
                    { 1, true, "Hasta 3 usuarios, módulos esenciales", 3, "Básico", 299m },
                    { 2, true, "Hasta 10 usuarios, reportes PDF/Excel", 10, "Profesional", 699m },
                    { 3, true, "Usuarios ilimitados, soporte prioritario", 50, "Empresarial", 1499m }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemsOrden_ProductoInventarioId",
                table: "ItemsOrden",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pagos_PlanSuscripcionId",
                table: "Pagos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tenants_PlanSuscripcionId",
                table: "Tenants",
                column: "PlanSuscripcionId");
